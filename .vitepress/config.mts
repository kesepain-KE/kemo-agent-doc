    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'v1.2.7 更新说明', link: '/releases/release-1.2.7' },
          { text: 'v1.2.6 更新说明', link: '/releases/release-1.2.6' },
          { text: 'v1.2.5 更新说明', link: '/releases/release-1.2.5' },
          { text: 'v1.2.4 更新说明', link: '/releases/release-1.2.4' },
          { text: 'v1.2.3 更新说明', link: '/releases/release-1.2.3' },
          { text: 'v1.2.2 更新说明', link: '/releases/release-1.2.2' },
          { text: 'v1.2.1 更新说明', link: '/releases/release-1.2.1' },
          { text: 'v1.2.0 更新说明', link: '/releases/release-1.2.0' },
          { text: 'v1.1.2 更新说明', link: '/releases/release-1.1.2' },
          { text: 'v1.1.1 更新说明', link: '/releases/release-1.1.1' },
          { text: 'v1.1.0 更新说明', link: '/releases/release-1.1.0' },
